...
export async function generateMetadata({
  ...
  return generatePageMetadata({
    ...
    image: paper.featuredImage
      ? urlFor(paper.featuredImage).width(1200).height(630).url()
      : undefined,
        ...
        <Container size="narrow">
          ...
          <div className="mt-10 p-6 bg-primary-50 rounded-xl">
            ...
            <p className="text-neutral-600 mb-4">
              Get the complete analysis with detailed findings, methodology, and
              recommendations.
            </p>
          ...
          <Container size="narrow">
            <div className="bg-white rounded-xl p-8 border border-neutral-200">
              ...
              <h2 className="text-2xl font-bold text-neutral-900 mb-4">
                {paper.relatedGuide.title}
              </h2>
              <p className="text-neutral-600 mb-6">
                For a practical guide on implementing these findings, check out
        ...
        <Container size="narrow">
          <div className="text-center">
            ...
            <p className="text-primary-100 mb-8 max-w-xl mx-auto">
              Our team can help you understand how these findings apply to your
              organisation.
            </p>
